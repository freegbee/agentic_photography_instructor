...
class StableBaselineTrainer(AbstractTrainer):
    ...
    def _train_impl(self):
        ...
        env_factory = ImageTransformEnvFactory(
            ...
            step_penalty=self.task_params["step_penalty"],
            reward_strategy_enum=self.task_params["reward_strategy"],
            success_bonus_strategy=self.task_params["success_bonus_strategy"],
