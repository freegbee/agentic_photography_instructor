...
class TransformationActor:
    def __init__(self):
        ...
        self.juror = JurorClient(use_local=True, use_cache=True, cache_maxsize=10000)
        logger.info(f"Juror Client {self.juror}")
        logger.info(f"Juror Client {self.juror._service}")
